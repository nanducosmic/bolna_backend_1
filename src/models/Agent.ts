...
export interface IAgent extends Document {
  ...
  purchasedPhoneNumber?: string; // SCOPE: Purchased phone number for outbound calls
...
const AgentSchema = new Schema<IAgent>({
  ...
  prompt: { 
    type: String, 
    required: true,
    default: "When confirming a booking, only state the date and time. Never mention URLs, event links, or technical IDs to the user."
  },
